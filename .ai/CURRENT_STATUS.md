...
> **منبع حقیقت:** `.ai/AI_CONTEXT.md` را بخوان. این فایل مال فروشگاه تکی v22 است و برای ربات همکار / کیف اعتبار / کمپین طلایی / فاکتور خدمات / ایزوله‌سازی multi-tenant به‌روز نیست.
