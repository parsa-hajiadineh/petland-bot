...
آمار فروش مادر ۱۲ ماه اخیر است و هر بار زنده از سفارش/فاکتور حساب می‌شود (آرشیو قدیمی دیگر منبع نمایش نیست). ماه به وقت تهران. بخش یوزر: حجم خرد PL- غیرعمده + کمیسیون ۵٪ معرفی + سود ناخالص = حجم خرد − کمیسیون. بخش همکار: حجم PL- عمده + فاکتور خدمات تاییدشده نقدی/اعتباری. شمار یوزر/همکار/ربات کل فعلی است؛ ثبت‌نام همان ماه جدا می‌آید.

مدیریت تیکت «✉️ ارسال پیام»: فیلتر مادر / همکار / مشتری یک فروشگاه / مشتری همه ربات‌ها / همه کاربرها / لیست دستی. ارسال انبوه در پس‌زمینه است تا poll قفل نشود.
