...
Scheduler هر ساعت دوره طلایی (۱۲ ساعت مانده / پایان، هر کدام یک‌بار) و هر روز تقویم تهران اشتراک (۵ روز مانده / پایان) و فاکتور خدمات پرداخت‌نشده (یک یادآوری بعد از حدود یک روز، حداکثر یک یادآوری دیگر بعد از سه روز) را برای **فقط همکاران** می‌فرستد. جدول `ColleagueNotice` جلوی تکرار است. مشتری فروشگاه همکار این پیام‌ها را نمی‌گیرد.
...
src/services/partnerNotify.js     نوتیف همکار روی ربات فروشگاه
