...
async function showCatalog(user, chatId, ctx, prefix = "") {
  ...
  await reply(
    ...
    chatId,
    `${prefix}💳 خرید اشتراک
قابلیت ایجاد دارایی و بازگشت وجه در خریدهای شما برای پت‌شاپتان فعال گردید. زین پس می‌توانید با اعتبار دریافتی خود، از بخش ساخت ربات فروشگاهی از پکیج‌ها و خدمات پلتفرم ما ذی‌نفع باشید.
در نظر داشته باشید که اولین فاکتور تاییدشده شما در ۴۸ ساعت آینده تا سقف ۱۰ میلیون تومان خرید، ۵۰ برابر اعتبار بیشتری برای شما خواهد ساخت.
در صورت تمایل به دیدن محصولات از دکمه بازگشت به منوی اصلی استفاده کنید.`,
